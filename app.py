...
try:
    ...
    FONT_PATH = 'C:/Windows/Fonts/Arial.ttf'  # Запасной вариант
    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while cap.isOpened():
            ...
            try:
                ...
                is_left_leg_lifted = (
                            left_leg_lift_angle < LEG_LIFT_THRESHOLD_ANGLE and left_knee_angle > KNEE_STRAIGHT_ANGLE)
                is_right_leg_lifted = (
                            right_leg_lift_angle < LEG_LIFT_THRESHOLD_ANGLE and right_knee_angle > KNEE_STRAIGHT_ANGLE)
                is_left_support_arabesque = (
                            left_knee_angle > KNEE_STRAIGHT_ANGLE and right_knee_angle > KNEE_STRAIGHT_ANGLE and arabesque_angle_left_support > ARABESQUE_THRESHOLD_MIN)
                is_right_support_arabesque = (
                            right_knee_angle > KNEE_STRAIGHT_ANGLE and left_knee_angle > KNEE_STRAIGHT_ANGLE and arabesque_angle_right_support > ARABESQUE_THRESHOLD_MIN)

                # --- ОБНОВЛЕНО: ЛОГИКА ОЦЕНКИ (Градуированная + Тайм-коды) ---
                ...
                # --- 3. Ласточка (Арабеск) ---
                        ...
                        is_left_support_arabesque or is_right_support_arabesque) and not leg_lift_in_progress and not split_in_progress:
            ...
            draw.text((50, 100), f"ВРЕМЯ: {current_time_str} | ИТОГО БАЛЛОВ: {total_score}", font=font_score,
                      fill=(255, 255, 0))
